...
public class Evaluasi11Fragment extends Fragment {

    private DatabaseReference mDatabase;
    private EditText answer1,answer2,answer3,answer4,answer5,answer6;

    public Evaluasi11Fragment() {}


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_evaluasi_11, container, false);
        assert getArguments() != null;
        String hash = getArguments().getString("HASH");
        final String name = getArguments().getString("NAME");
        mDatabase = FirebaseDatabase.getInstance().getReference("KegiatanSatu");
        ...
        if(!hash.equals("guru")){
            ...
            answer6.setText(hasilEvaluasi.getAnwswer6());
        }
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(jawab1.isEmpty() || jawab2.isEmpty() || jawab3.isEmpty() || jawab4.isEmpty() || jawab5.isEmpty() || jawab6.isEmpty()){
                    Toast.makeText(requireContext(),"Isi jawaban yang kosong" , Toast.LENGTH_SHORT).show();
                }else{
                    sendAnswer(name,jawab1,jawab2,jawab3,jawab4,jawab5,jawab6);
                }
            }
        });
    ...
    private void sendAnswer(String users,String jwb1,String jwb2,String jwb3,String jwb4,String jwb5,String jwb6) {
        ...
        maps.put("answer6", jwb6);
        maps.put("status", "0");
        maps.put("nilai", "");
        mDatabase.child("AktivitasSatu").push().setValue(maps).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
