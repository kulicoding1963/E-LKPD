 ...
 */
public class Evaluasi22Fragment extends Fragment {

    private DatabaseReference mDatabase;
    private EditText answer1,answer2,answer3,answer4;

    public Evaluasi22Fragment() {}


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_evaluasi_22, container, false);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(jawab1.isEmpty() || jawab2.isEmpty() || jawab3.isEmpty() || jawab4.isEmpty()){
                    Toast.makeText(requireContext(),"Isi jawaban yang kosong" , Toast.LENGTH_SHORT).show();
                }else{
                    sendAnswer(name,jawab1,jawab2,jawab3,jawab4);
                }
            }
        });
    ...
    private void sendAnswer(String users,String jwb1,String jwb2,String jwb3,String jwb4) {
