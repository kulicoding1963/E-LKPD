 ...
 */
public class Evaluasi24Fragment extends Fragment {

    private DatabaseReference mDatabase;
    private EditText answer1,answer2,answer3,answer4,answer5;

    public Evaluasi24Fragment() {}


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_evaluasi_24, container, false);
    ...
    private void sendAnswer(String users,String jwb1,String jwb2,String jwb3,String jwb4,String jwb5) {
        ...
        maps.put("status", "0");
        maps.put("nilai", "");
        mDatabase.child("AktivitasEmpat").push().setValue(maps).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
